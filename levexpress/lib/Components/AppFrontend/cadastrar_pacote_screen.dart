...
class CadastrarPacoteScreen extends StatefulWidget {
  const CadastrarPacoteScreen({super.key});

  @override
  CadastrarPacoteScreenState createState() => CadastrarPacoteScreenState();
}

class CadastrarPacoteScreenState extends State<CadastrarPacoteScreen> {
